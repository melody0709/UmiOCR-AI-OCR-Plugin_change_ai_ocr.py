...
class Api:
    ...
    def _build_prompt(self, argd):
        ...
        if output_format == 'with_coordinates':
            prompt += " Format: [x1,y1,x2,y2] text_content. Use pixel coordinates from top-left origin."
        else:
            prompt += " Maintain original layout and formatting."
        
        prompt += " Return empty if no text found."
